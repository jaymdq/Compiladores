...
public class AnalizadorLexico {
	...
	private static void init() {
		...
		/*
			...
			matrizTransicion.setTransicion(Estado.UNO, TipoSimbolo.INVALIDO, new Transicion(Estado.UNO, new AS9()));
			...
			matrizTransicion.setTransicion(Estado.DOS, TipoSimbolo.PUNTO, new Transicion(Estado.ONCE, new AS15()));
			...
			// Estado 11
			matrizTransicion.setTransicion(Estado.ONCE, TipoSimbolo.PUNTO, new Transicion(Estado.DOCE));
			matrizTransicion.setDefault(Estado.ONCE, new Transicion(Estado.INICIAL, new AS13()));

			// Estado 12
			matrizTransicion.setTransicion(Estado.DOCE, TipoSimbolo.DIGITO, new Transicion(Estado.TRECE));
			matrizTransicion.setDefault(Estado.ONCE, new Transicion(Estado.INICIAL, new AS13()));

			// Estado 13
			matrizTransicion.setTransicion(Estado.TRECE, TipoSimbolo.DIGITO, new Transicion(Estado.TRECE));
			matrizTransicion.setDefault(Estado.ONCE, new Transicion(Estado.FINAL, new AS13()));
