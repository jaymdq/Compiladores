%token IDENTIFICADOR ENTERO ENTERO_LSS CADENA_MULTILINEA PR_SI PR_ENTONCES PR_SINO PR_IMPRIMIR PR_ENTERO PR_ENTERO_LSS	PR_ITERAR PR_HASTA PR_VECTOR PR_DE
%left '-' '+'
%left '*' '/'
...
impresion	: PR_IMPRIMIR '\(' CADENA_MULTILINEA '\)'	{ConsolaManager.getInstance().escribir($3);}
			;
